...
.factory('mshiftService', 
	...
	service.GetListScheduleApi=function(reqData, callback){
		$http.post($cookies.get('hostname')+'/PAMS_api/schedule/listScheduleByWeek', reqData)
		.success(function (respData, status, headers, config) {
			callback(respData);
		})
		.error(function(respData, status, headers, config) {
	...
	service.createScheduleApi=function(reqData, callback){
		$http.post($cookies.get('hostname')+'/PAMS_api/schedule/createSchedule', reqData)
		.success(function (respData, status, headers, config) {
			callback(respData);
		})
		.error(function(respData, status, headers, config) {
